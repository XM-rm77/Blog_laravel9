...
<html>
	...
	<nav class="fh5co-nav" role="navigation">
		<div class="top-menu">
			<div class="container-fluid">
				<div class="row">
					<div class="col-xs-2">
						<div id="fh5co-logo"><a href="index.html">Blog<span>.</span></a></div>
					</div>
	...
	<aside id="fh5co-hero" class="js-fullheight">
		<div class="flexslider js-fullheight">
			<ul class="slides">
		   	<li style="background-image: url(../../frontend_assets/images/img_bg_1.jpg);">
		   	...
		   	<li style="background-image: url(../../frontend_assets/images/img_bg_2.jpg);">
		   		<div class="overlay-gradient"></div>
		   		<div class="container-fluid">
		   			<div class="row">
			   			<div class="col-md-6 col-md-offset-3 col-md-pull-3 js-fullheight slider-text slider-text-bg">
		   	...
		   	<li style="background-image: url(../../frontend_assets/images/img_bg_3.jpg);">
		   		<div class="overlay-gradient"></div>
	...
	<div id="fh5co-content">
		<div class="video fh5co-video" style="background-image: url(../../frontend_assets/images/video.jpg);">
